...
public class Vydaj implements ActionListener{
    ...
    Vydaj(Double vyber, int pocet){

        suma = vyber;
        bankovky = pocet;
        
        frame.setTitle("Vydaj");
        ...
        //tlacidla
        vyberButton.setBounds(30, 368, 80, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == spatButton){
            Potvrdenie potvrdenie = new Potvrdenie(suma, bankovky);
            frame.dispose();
        }
